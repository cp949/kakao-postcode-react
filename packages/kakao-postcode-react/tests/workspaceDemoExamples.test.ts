...
describe("workspace demo examples", () => {
  it("shows one dialog example with a caller result summary and code snippet", () => {
    ...
    expect(dialogSource).toContain('maxWidth="xs"');
    expect(dialogSource).toContain("fullWidth");
    expect(dialogSource).toContain("IFRAME_HEIGHT");
    expect(dialogSource).toContain("loadingFallback");
    expect(dialogSource).toContain("errorFallback");
    expect(dialogSource).toContain("autoClose");
    expect(dialogSource).toContain("COMPLETE_CLOSE");
    expect(dialogSource).toContain('width="100%"');
    expect(dialogSource).toContain("onComplete");
    expect(dialogSource).toContain("주소 검색");
    ...
    expect(codeCardSource).toContain('maxWidth="xs"');
    expect(codeCardSource).toContain("IFRAME_HEIGHT");
    expect(codeCardSource).toContain("loadingFallback");
    expect(codeCardSource).toContain("errorFallback");
    expect(codeCardSource).toContain("autoClose");
    expect(codeCardSource).toContain("COMPLETE_CLOSE");
